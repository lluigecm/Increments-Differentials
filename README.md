<h1>Calculadora de Incrementos e Diferenciais com Interface Gráfica</h1>
...
* Suporta funções matemáticas de até três variáveis, usando a sintaxe padrão matemática (ex: x^2 + 2&asty&astz).
